    ...
    <div className="homepage">
      ...
      <div className="right-side">
        <div className="twitter-login icon has-text-info">
          ...
          <Link to="/signin" className="button is-outlined">
            Sign in
          </Link>
        </div>
        ...
        <div className="twitter-join">
          ...
          <div className="group-button">
            <Link to="/signup" className="button is-info is-fullwidth">
              Sign up
            </Link>
            <Link to="/signin" className="button is-outlined is-fullwidth">
              Sign in
            </Link>
          </div>
        </div>
