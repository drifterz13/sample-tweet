...
class ResetPasswordForm extends React.Component {
  ...
  handleSubmit = e => {
    ...
    api.resetPassword(`/api/user/reset_password`)
    .reset(body)
    ...
    return (
      <div className='body-reset-wrapper'>
        <form className='form-reset-wrapper' onSubmit={this.handleSubmit}>
          {this.state.notMatch && <p className='help-reset'>Password not match!</p>}
          <div className='field'>
          ...
          <div className='control'>
            <button style={{ marginLeft: 'auto' }} className='button is-info'>Submit</button>
          </div>
        </form>
      </div>
    )
